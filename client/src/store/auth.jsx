...
export const AuthProvider = ({ children }) => {
  ...
  const userAuthentication = async () => {
    try {
      ...
      const response = await fetch("https://gigswap-hsp-server.vercel.app/api/auth/user", {
        method: "GET",
        headers: {
  ...
  const getServices = async () => {
    try {
      const response = await fetch("https://gigswap-hsp-server.vercel.app/api/data/service");
      if (response.ok) {
        const data = await response.json();
