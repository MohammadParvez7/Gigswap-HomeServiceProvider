...
export const AdminContacts = () => {
  ...
  const getContactsData = async () => {
    try {
      const response = await fetch("https://gigswap-hsp-server.vercel.app/api/admin/contacts", {
        method: "GET",
        headers: {
  ...
  const deleteContactById = async (id) => {
    try {
      const response = await fetch(`https://gigswap-hsp-server.vercel.app/api/admin/contacts/delete/${id}`, {
        method: "DELETE",
        headers: {
          Authorization: authorizationToken,
        },
